...
void dialogue_window::print_header( const std::string &name ) const
{
    ...
    bool debug_flags[flag_count] = {show_dynamic_line_conditionals, show_response_conditionals, show_dynamic_line_effects, show_response_effects};
    std::string debug_show_toggle[flag_count] = { "DL_COND", "RESP_COND", "DL_EFF", "RESP_EFF" };
    if( debug_mode ) {

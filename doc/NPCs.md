...
---|---|---
`<acknowledged>` | `<acknowledged>` | see data/json/npcs/talk_tags_line.json
`<camp_food_thanks>` | `<camp_food_thanks>` | see data/json/npcs/talk_tags_line.json
`<camp_larder_empty>` | `<camp_larder_empty>` | see data/json/npcs/talk_tags_line.json
`<camp_water_thanks>` | `<camp_water_thanks>` | see data/json/npcs/talk_tags_line.json
...
`<hungry>` | `<hungry>` | see data/json/npcs/talk_tags_line.json
`<im_leaving_you>` | `<im_leaving_you>` | see data/json/npcs/talk_tags_line.json
`<its_safe_h>` | `<its_safe_h>` | see data/json/npcs/talk_tags_line.json
`<its_safe>` | `<its_safe>` | see data/json/npcs/talk_tags_line.json
`<keep_up>` | `<keep_up>` | see data/json/npcs/talk_tags_line.json
...
`<need_batteries>` | `<need_batteries>` | see data/json/npcs/talk_tags_line.json
`<need_booze>` | `<need_booze>` | see data/json/npcs/talk_tags_line.json
`<need_fuel>` | `<need_fuel>` | see data/json/npcs/talk_tags_line.json
...
`<thirsty>` | `<thirsty>` | see data/json/npcs/talk_tags_line.json
`<wait>` | `<wait>` | see data/json/npcs/talk_tags_line.json
`<warn_sleep>` | `<warn_sleep>` | see data/json/npcs/talk_tags_line.json
`<yawn>` | `<yawn>` | see data/json/npcs/talk_tags_line.json
